            ...
            <div class="card">
              ...
              <?php if(isset($validation)):?>
                ...
                ?>
                  ...
                  <form method="post" action="<?=base_url('/admin/brands/updatebrands'); ?>" enctype="multipart/form-data">
                    <div class="col-sm-12 mt-4 mb-4 pl-4 pr-4">
                        <div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-default">
                              <label class="float-label">Name</label>
                              <input type="text" name="name" class="form-control" required="" value="<?= $brand_data['name'] ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-default">
                                ...
                                <select class="form-control" name="status">
                                  ...
                                  <option value="1" <?php if($brand_data['status'] == 1){ echo 'selected="selected"'; } ?>>Active</option>
                                  <option  value="0" <?php if($brand_data['status'] == 0){ echo 'selected="selected"'; } ?> >Draft</option>
                                </select>
                                <span class="form-bar"></span>
                            </div>
                        </div>
