          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header p-2">
                <h2 class="card-title">Update Sub-Categories</h2>
                
              </div><!-- /.card-header -->
              <form role="form" action="<?=  base_url('/admin/category/update-sub-category');?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                            ...
                            <select class="form-control" name="parent_id">
                                <?php 
                                  ...
                                  { ?>
                                    ...
                                    <?php 
                                        if($category_data['parent_id'] == $parent_category['id'])
                                        { echo ' selected= " " ';}
                                    ?>
                                    > 
