        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="#">Subscription</a></li>
            ...
            <div class="card">
              <div class="card-header p-2">
                ...
                <div class="text-right">
                  <a href="<?= base_url('admin/subscription/create-plan') ?>" class="btn btn-primary">Add New</a>
                </div>
              </div><!-- /.card-header -->
              <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  <?php  
                    ...
                    {
                        $i = 1;
                        foreach($SubscriptionPlans as $SubscriptionPlans)
                        { 
                         
                            ?>
                            <tr>
                                <td><?php echo $i++ ;?></td>
                                <td><img src="<?= base_url(); ?>/public/uploads/<?php echo $SubscriptionPlans->icon ?>" with="40" height="40"></td>
                                <td><?php  echo $SubscriptionPlans->name;  // echo $SubscriptionPlans["name"] ;

                                ?></td>
                                <td><?php echo $SubscriptionPlans->duration ;?></td>
                                <td><?php echo $SubscriptionPlans->amount ;?></td>
                                <td>
                                    <?php 
                                    if($SubscriptionPlans->status == 1)
                                    {
                                        echo '
                                        <a href="#" class="text-decoration-none update_state" data-value="0" 
                                        data-id="'.$SubscriptionPlans->id.'">
                                            <i class="fa fa-check text-success"></i>
                                        </a>
                                        ';
                                    }else{
                                        echo '
                                        <a href="#" class="text-decoration-none update_state" data-value="1" data-id="'.$SubscriptionPlans->id.'">
                                ...
                                <td>
                                <a href="<?= base_url(); ?>/admin/subscription/<?= $SubscriptionPlans->id ?>/edit">Edit</a>
                                <span class="text-primary">&nbsp; | &nbsp;</span>
                                <a href="javascript:void(0);" class="delete_category" data-id="<?= $SubscriptionPlans->id; ?>">Delete</a>
...
<!-- ./wrapper -->
    ...
    <!-- Modal Update Category-->
      <form action="<?=base_URL();?>/admin/subscription/update_status" method="post">
    ...
    <form action="<?=base_URL();?>/admin/subscription/delete_plan" method="post">
