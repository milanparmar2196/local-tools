            ...
            <div class="card">
              <div class="card-header p-2">
                ...
                <div class="text-right">
                  <a href="<?= base_url('admin/tax/create-tax') ?>" class="btn btn-primary">Add New</a>
                </div>
              </div><!-- /.card-header -->
              <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if($tax['status'] == 1)
                                    {
                                        ...
                                        echo '
                                        <a href="#" class="text-decoration-none update_state" data-value="1" data-id="'.$tax["id"].'">
                                ...
                                <td>
                                <a href="<?= base_url(); ?>/admin/tax/<?= $tax["id"] ?>/edit">Edit</a>
                                <span class="text-primary">&nbsp; | &nbsp;</span>
                                <a href="javascript:void(0);" class="delete_category" data-id="<?= $tax["id"]; ?>">Delete</a>
...
<!-- ./wrapper -->
    ...
    <!-- Modal Update Category-->
      <form action="<?=base_URL();?>/admin/tax/update_status" method="post">
    ...
    <form action="<?=base_URL();?>/admin/tax/delete_tax" method="post">
