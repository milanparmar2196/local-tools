            ...
            <div class="card">
              <div class="card-header p-2">
                ...
                <div class="text-right">
                  <a href="<?= base_url('admin/category/create') ?>" class="btn btn-primary">Add New</a>
                </div>
              </div><!-- /.card-header -->
              <div class="card-body">
                    ...
                    if($category_data)
                    {
                        ...
                        { 
                            ...
                            <tr>
                                <td><?php echo $i++ ;?></td>
                                <td>
                                  <img src="<?= "../public/uploads/" .$category["icon"]; ?>" width="32" />  
                                </td>
                                ...
                                <td>
                                    ...
                                    $id = $category['id'];
                                    $data['category_count'] = $categoryModel->where('parent_id', $id)->countAllResults();
                                      echo $data['category_count'];
                                     
                                    ?>
                                </td>
                                <td>
                                  <a class="btn btn-primary" href="<?php echo base_url(); ?>/admin/category/<?= $category['id']; ?>/view_subcategory">View Subcategory</a>
                                </td>
                                <td>
                                    <?php 
                                    if($category['is_active'] == 1)
                                    {
                                        ...
                                        echo '
                                        <a href="#" class="text-decoration-none update_state" data-value="1" data-id="'.$category["id"].'">
                                ...
                                <td>
                                <a href="<?= base_url(); ?>/admin/category/<?= $category["id"] ?>/edit">Edit</a>
...
<!-- ./wrapper -->
    ...
    <!-- Modal Update Category-->
      <form action="<?=base_URL();?>/admin/category/update_status" method="post">
    ...
    <form action="<?=base_URL();?>/admin/category/delete_category" method="post">
