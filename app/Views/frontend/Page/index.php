      ...
      <div class="main-section">
            <div class="grid-view">
                <div class="productbox">
                    ...
                    <figure>
                        <img src="<?php echo base_url(); ?>/images/products/garden-tools.png">
                    </figure>
                ...
                <div class="productbox">
                    ...
                    <figure>
                        <img src="<?php echo base_url(); ?>/images/products/kfz.png">
                    </figure>
                ...
                <div class="productbox">
                    ...
                    <figure>
                        <img src="<?php echo base_url(); ?>/images/products/cordless.png">
                    </figure>
                ...
                <div class="productbox">
                    ...
                    <figure>
                        <img src="<?php echo base_url(); ?>/images/products/zigma.png">
                    </figure>
                ...
                <div class="productbox">
                    ...
                    <figure>
                        <img src="<?php echo base_url(); ?>/images/products/tata.png">
                    </figure>
                ...
                <div class="productbox">
                    ...
                    <figure>
                        <img src="<?php echo base_url(); ?>/images/products/winex.png">
                    </figure>
                    <label>hand Tools</label>
                    <div class="d-flex justify-content-between align-items-center">
                        <h4>Winex Hand Tools</h4>
                        <span>$1/Day</span>
                    </div>
                    <label><i class="bi bi-geo-alt"></i> George Colony California</label>
                </div>
                ...
                <div class="productbox">
                    ...
                    <figure>
                        <img src="<?php echo base_url(); ?>/images/products/zitex.png">
                    </figure>
                    <label>Pump</label>
                    <div class="d-flex justify-content-between align-items-center">
                        <h4>Zitex submersible Pump</h4>
                        <span>$1/Day</span>
                    </div>
                    <label><i class="bi bi-geo-alt"></i> George Colony California</label>
                </div>
            ...
            <!--- Yellow Footer --->
                <div class="yellow-footer">
                    <div class="logo">
                        <figure>
                            <img src="<?php echo base_url(); ?>/images/why-logo.png">
                        </figure>
                    </div>
                    ...
                    <div class="free-shipping text-center">
                        <figure class="icon">
                            <img src="<?php echo base_url(); ?>/images/icons/free-shipping.svg">                            
                        </figure>
                        <h5>Free Shipping</h5>
                    ...
                    <div class="money text-center">
                        <figure class="icon">
                            <img src="<?php echo base_url(); ?>/images/icons/money.svg">                            
                        </figure>
                    ...
                    <div class="support text-center">
                        <figure class="icon">
                            <img src="<?php echo base_url(); ?>/images/icons/suppoort.svg">                           
                        </figure>
                        <h5>24/7 Support</h5>
                    ...
                    <div class="secure-payment text-center">
                        <figure class="icon">
                            <img src="<?php echo base_url(); ?>/images/icons/payment.svg">                            
                        </figure>
